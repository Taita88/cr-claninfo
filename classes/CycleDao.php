...
class CycleDao
{
    ...
    public function getAllCycleWithMembers()
    {
        ...
        //TODO: find better way for filling cycles with members without cloning
    ...
    {
        $query = "INSERT INTO cycle (year, week_of_year) " . "VALUES (" . $cycle->getYear() . " ," . "" . $cycle->getWeekOfYear() . ")";
